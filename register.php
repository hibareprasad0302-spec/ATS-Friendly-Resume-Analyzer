...
<body class="bg-gray-50 min-h-screen flex items-center justify-center font-sans text-gray-900 antialiased px-4 relative overflow-hidden">
    ...
    <!-- Decorative blobs -->
    <div class="hero-blob" style="width:400px;height:400px;background:radial-gradient(circle,#818cf8 0%,transparent 70%);top:-100px;left:-120px;animation:blobDrift2 10s ease-in-out infinite;opacity:0.6"></div>
    <div class="hero-blob" style="width:350px;height:350px;background:radial-gradient(circle,#a78bfa 0%,transparent 70%);bottom:-80px;right:-100px;animation:blobDrift1 12s ease-in-out infinite;opacity:0.55"></div>
    <div class="hero-blob" style="width:200px;height:200px;background:radial-gradient(circle,#f472b6 0%,transparent 70%);top:30%;right:-30px;animation:blobDrift2 14s ease-in-out infinite;opacity:0.4"></div>
    ...
    <div class="relative z-10 w-full max-w-sm">
        ...
        <div class="bg-white border border-gray-200/80 rounded-2xl p-8 shadow-sm">
            <h1 class="text-xl font-semibold text-gray-900 mb-6 text-center">Create account</h1>
            ...
            <form id="register-form">
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" class="pwd-toggle absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 transition" data-target="password_confirm">
                            <svg class="eye-open w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                            <svg class="eye-closed w-4 h-4 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 3l18 18M10.5 10.677a2 2 0 002.823 2.823"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7.362 7.561C5.68 8.74 4.279 10.42 3 12c1.889 2.991 5.282 6 9 6 1.55 0 3.043-.523 4.395-1.35M12 6c3.718 0 7.111 3.009 9 6-.947 1.498-2.057 2.85-3.362 3.83"/></svg>
                        </button>
                    </div>
                ...
                <p id="register-error" class="text-sm text-danger mb-4 hidden"></p>
            ...
            <p class="text-center text-xs text-gray-400 mt-6">
                Already have an account? <a href="/login.php" class="text-indigo-600 hover:text-indigo-700">Login</a>
            </p>
        </div>
    </div>
